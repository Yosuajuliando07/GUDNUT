            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="profile-card">
                                        ...
                                        <div class="profile-body">
                                                <div class="image-area">
                                                    <form action="{{route('penjual.foto.profil.update')}}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <a href="javascript:ambilGambar()" class="col-teal">
                        ...
                        <form action="{{route('penjual.profil.update')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                <div class="row clearfix">
                        ...
                        <form action="{{route('penjual.update.password')}}" method="POST" class="form-horizontal">
                        @csrf
                        @method('PUT')
                            <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
