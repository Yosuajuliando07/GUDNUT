            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="form-group">
                        <img id="preview" src="{{url ('/upload/slider/'.$sliders->gambar)}}" class="uploadslide"/><br/>
                        <input type="file" name="gambar" id="image" style="display: none;"/><br>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                 <textarea name="keterangan" rows="2" class="form-control" placeholder="Keterangan">{{$sliders->keterangan}}</textarea>
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="demo-radio-button">
                                        <input name="status" type="radio" class="with-gap" id="radio_3" value="1" {{ ($sliders->status == true) ? "checked" : "" }} >
                                        <label for="radio_3"><p class="font-bold col-teal">Aktif</p></label>
                                        <input name="status" type="radio" id="radio_4" class="with-gap radio-col-blue-grey" value="0" {{ ($sliders->status == false) ? "checked" : "" }}>
