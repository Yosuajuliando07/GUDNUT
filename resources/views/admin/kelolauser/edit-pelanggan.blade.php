...
@section('judul','Form Edit Pelanggan')
        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                <form action="{{ route('pelanggan.update', ['id' => $users->id]) }}" method="POST">
                                 @csrf
                                 @method('PUT')
                                ...
                                <a href="{{route('pelanggan.index')}}" type="submit" class="btn bg-teal waves-effect">Kembali</a>
